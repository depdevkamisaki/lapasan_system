...
<img src="{{url('uploads/user_img/Picture1.png')}}" width="1000px;" height="1250px" style="margin-top: 50px;">
		...
		@foreach($resident as $res)
			<div style="text-align: center; margin-top: 60px;">
				...
				<p style="font-weight: 900;font-size: 25px; text-decoration: underline;">CERTIFICATE OF RESIDENCY</p>
			...
			<input type="hidden" name="" id="DATERES" value="{{$res->resident_dateofresidency}}">

			<input type="hidden" name="" id="DOB" value="{{$res->resident_birthdate}}">
			<p class="paragraph">&nbsp &nbsp &nbspThis is to certify that <span style="text-decoration: underline; text-transform: uppercase; font-weight: 600">{{$res->resident_fullname}}, <span id="AGE"></span></span> and presently residing at Sitio {{$res->resident_sitio}}, Lapasan, Cagayan de Oro City, for almost <span id="TOTALYRLIVED"></span> years up to the present as stated in his/her Sitio Clearance Submitted to this office.
			</p>

			<p class="paragraph">&nbsp &nbsp &nbsp This certification is issued upon the request of the above-named person as a requirement for <span style="text-transform: uppercase; font-weight: 600; text-decoration: underline;">{{session()->get('session_document_purpose')}}</span> and for whatever legal intent it may serve him/her best. 
			</p>


			<p class="paragraph">&nbsp &nbsp &nbsp Issued this <span id="DAY"></span> day of <span id="MONTH"></span>, <span id="YEAR"></span> at Lapasan, Cagayan de Oro City.	
			</p>
