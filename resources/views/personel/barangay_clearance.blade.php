...
<img src="{{url('uploads/user_img/Picture1.png')}}" width="1000px;" height="1250px" style="margin-top: 50px;">
		...
		<div style="width: 25%; text-align: center;position: absolute;top: 15px;left: 16px; font-size: 14px; color:white;text-shadow: 0 0 0px #fff;" >
			...
			<p>Chairperson, Finance Committee,
			...
			<p>Chairperson, Infrastructure and Public Works</p>
			<p  class="pheader">BARANGAY KAGAWAD</p>
			...
			<p>Chairperson, Peace and Order, Public Utility& Safety</p>
			<p  class="pheader">BARANGAY KAGAWAD</p>


			<p  class="pheader">HON. ASPIRINO N.  BACONGA</p>
			<p>Chairperson, Environmental Protection, Sanitation, Agriculture & Fisheries Development, Civic and Sitio Affairs</p>
			<p  class="pheader">BARANGAY KAGAWAD</p>


			<p  class="pheader">HON. FORTUNATO S.  MELODIA</p>
			<p>Chairperson, Health and Social Services Cooperatives, Business and Investment</p>
			<p>BARANGAY KAGAWAD</p>


			<p  class="pheader">HON. ROWENA RAYE M. MEDIANA</p>
			<p>Chairperson, Education and Tourism</p>
			<p  class="pheader">BARANGAY KAGAWAD</p>


			<p  class="pheader">HON. CAROL JANE A. BILAR</p>
			<p>Committee on Youth Sports and Cultural Development</p>
		...
		<div style="width: 60%; position: absolute;top: 8px;right: 60px; padding-top: 30px; font-size: 20px;">
		...
		@foreach($resident as $res)
			<div style="text-align: center; margin-top: 60px;">
				...
				<p style="font-weight: 900;font-size: 25px; text-decoration: underline;">BARANGAY CLEARANCE</p>
			...
			<table  style="width: 100%;">
				<tr>
					<td style="width: 100%;">
						<img src="{{ asset('uploads/user_img/' . $res->resident_image) }}" alt="Image not found" style="width: 150px; height: 150px; margin-right: 1px;">
					</td>
			...
			<p class="paragraph">
				This is to certify that <span style="text-decoration: underline; text-transform: uppercase; font-weight: 600">{{$res->resident_fullname}}</span>, of legal age, and presently residing at Sitio <span style="font-weight: 600;">{{$res->resident_sitio}}</span> , Lapasan, Cagayan de Oro City, a GOOD MORAL character and has no derogatory record as stated in his/her Sitio Clearance Submitted to this office.
			</p>

			<p class="paragraph">
				This certification is issued upon the request of the above-named person as a requirement for <span style="text-transform: uppercase; font-weight: 600; text-decoration: underline;">{{session()->get('session_document_purpose')}}</span> and for whatever legal intent it may serve him/her best. 
			...
			<p class="paragraph">
				Issued this <span id="DAY"></span> day of <span id="MONTH"></span>, <span id="YEAR"></span> at Lapasan, Cagayan de Oro City.	
			</p>
