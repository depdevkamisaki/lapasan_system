...
<div class="wrapper">
        ...
        <div class="container">
            <h5 class="text-right"><i class="fa fa-user" aria-hidden="true"></i> Resident Info</h5>
        </div>
...
<form action="/save_resident_info" method="get">
	<input type="hidden" name="resident_id" value="{{$res->resident_id}}">
	...
	<div class="container-row">
		<h6>New Longitude: {{$res->resident_longitude}}, Latitude{{$res->resident_latitude}}</h6>
	</div>
	<div class="container-row">
		<p>Coordinates Already updated and the system still processing changes.</p>
	</div>
...
<div style="text-align: right;">
	<form action="/resident_records" method="get">
...
<form action="/delete_resident" method="get">
	<input type="hidden" name="resident_id" value="{{$res->resident_id}}">
    <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Type 'CONFIRM' to delete record" aria-label="" name="search" aria-describedby="basic-addon2">
...
<p class="tiny_message warning">This Resident Information is Deleted, Do you wish to Restore? </p>
<form action="/restore_data" method="get">

	<input type="hidden" name="data_type" value="resident">
	<input type="hidden" name="resident_id" value="{{$res->resident_id}}">
    <div class="input-group mb-3">
